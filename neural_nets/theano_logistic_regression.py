...
def sgd_optimization(learning_rate=0.13, n_epochs=1000, batch_size=600, problem='mnist', **kwargs):
...
if __name__ == '__main__':
    ...
    sgd_optimization(problem=args.problem, data_file=args.data_file, valid_size=args.valid_size)
